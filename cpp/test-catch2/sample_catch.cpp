...
TEST_CASE("SalaryPensionContributionCalculation") {
    ...
    SECTION("Junior Employee With No Tenure - Basic Contribution") {
        auto fakePercentages = FakePercentages::getStandardValues();
    ...
    SECTION("Mid Level Recent Hire - Medium Contribution") {
        auto fakePercentages = FakePercentages::getStandardValues();
    ...
    SECTION("Mid Level Medium Tenure - Medium Large Contribution") {
        auto fakePercentages = FakePercentages::getStandardValues();
    ...
    SECTION("Leadership With Long Tenure - Maximum Contribution") {
        auto fakePercentages = FakePercentages::getStandardValues();
